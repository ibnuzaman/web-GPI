...
<body>
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container-fluid">
            <a class="navbar-brand ps-3" href="index.html"><img src="./assets/img/logo GPI.png" alt=""
                    width="100px"></a>
        ...
        <div class="container pt-5 footer">
            <div class="row row-content">
                ...
                <div class="col-md-4 mt-4 mt-sm-0">
                    ...
                    <p>Jasa Injection, Manufacture PE (Foam Bag, Foam Sheet, Laminasi, Bonding, Insulation Roof), PU
                        Foam Tape, EPDM Foam Tape, Styrofoam & Produk Rubber</p>
                </div>
            </div>
