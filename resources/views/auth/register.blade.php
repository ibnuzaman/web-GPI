<x-app-layout-auth title="Auth">
    <button id="back-button" style="background: none; border: none; padding: 0;">
        <a href="{{ route('home') }}" style="text-decoration: none; color: inherit; display: flex; align-items: center;">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#2A4264" class="bi bi-arrow-left"
                viewBox="0 0 16 14" aria-label="Back">
